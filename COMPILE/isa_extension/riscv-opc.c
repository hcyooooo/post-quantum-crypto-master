...
/* Todo: Use PQ extension instead of I */
{"pq.set_kyber",       "I", "d,s,t", MATCH_PQ_SET_KYBER, MASK_PQ_SET_KYBER, match_opcode, 0},
{"pq.set_newhope512",  "I", "d,s,t", MATCH_PQ_SET_NEWHOPE512, MASK_PQ_SET_NEWHOPE512, match_opcode, 0},
{"pq.set_newhope1024", "I", "d,s,t", MATCH_PQ_SET_NEWHOPE1024, MASK_PQ_SET_NEWHOPE1024, match_opcode, 0},
{"pq.set_fwd_ntt",     "I", "d,s,t", MATCH_PQ_SET_FWD_NTT, MASK_PQ_SET_FWD_NTT, match_opcode, 0},
{"pq.set_inv_ntt",     "I", "d,s,t", MATCH_PQ_SET_INV_NTT, MASK_PQ_SET_INV_NTT, match_opcode, 0},
{"pq.set_first_rounds","I", "d,s,t", MATCH_PQ_SET_FIRST_ROUNDS, MASK_PQ_SET_FIRST_ROUNDS, match_opcode, 0},
{"pq.set_last_round",  "I", "d,s,t", MATCH_PQ_SET_LAST_ROUND, MASK_PQ_SET_LAST_ROUND, match_opcode, 0},

{"pq.ntt_multiple_bf", "I", "d,s,t", MATCH_PQ_NTT_MULTIPLE_BF, MASK_PQ_NTT_MULTIPLE_BF, match_opcode, 0},
{"pq.ntt_single_bf",   "I", "d,s,t", MATCH_PQ_NTT_SINGLE_BF, MASK_PQ_NTT_SINGLE_BF, match_opcode, 0},
{"pq.update_m",        "I", "d,s,t", MATCH_PQ_UPDATE_M, MASK_PQ_UPDATE_M, match_opcode, 0},
{"pq.update_omega",    "I", "d,s,t", MATCH_PQ_UPDATE_OMEGA, MASK_PQ_UPDATE_OMEGA, match_opcode, 0},
{"pq.mul_gamma1",      "I", "d,s,t", MATCH_PQ_MUL_GAMMA1, MASK_PQ_MUL_GAMMA1, match_opcode, 0},
{"pq.mul_gamma2",      "I", "d,s,t", MATCH_PQ_MUL_GAMMA2, MASK_PQ_MUL_GAMMA2, match_opcode, 0},
{"pq.update_gamma",    "I", "d,s,t", MATCH_PQ_UPDATE_GAMMA, MASK_PQ_UPDATE_GAMMA, match_opcode, 0},

{"pq.mod_mul_r",       "I", "d,s,t", MATCH_MOD_MUL_R, MASK_MOD_MUL_R, match_opcode, 0},
{"pq.mod_add_r",       "I", "d,s,t", MATCH_MOD_ADD_R, MASK_MOD_ADD_R, match_opcode, 0},
{"pq.mod_sub_r",       "I", "d,s,t", MATCH_MOD_SUB_R, MASK_MOD_SUB_R, match_opcode, 0},
{"pq.bf_dit",          "I", "d,s,t", MATCH_PQ_BF_DIT, MASK_PQ_BF_DIT, match_opcode, 0},
{"pq.bf_dif",          "I", "d,s,t", MATCH_PQ_BF_DIF, MASK_PQ_BF_DIF, match_opcode, 0},
{"pq.mod_mul_f",       "I", "d,s,t", MATCH_MOD_MUL_F, MASK_MOD_MUL_F, match_opcode, 0},
{"pq.mod_add_f",       "I", "d,s,t", MATCH_MOD_ADD_F, MASK_MOD_ADD_F, match_opcode, 0},
{"pq.mod_sub_f",       "I", "d,s,t", MATCH_MOD_SUB_F, MASK_MOD_SUB_F, match_opcode, 0},

{"pq.sh_br256",        "I", "d,s,t", MATCH_SH_BR256, MASK_SH_BR256, match_opcode, 0},
{"pq.sh_br512",        "I", "d,s,t", MATCH_SH_BR512, MASK_SH_BR512, match_opcode, 0},
{"pq.sh_br1024",       "I", "d,s,t", MATCH_SH_BR1024, MASK_SH_BR1024, match_opcode, 0},

{"keccak.f1600",       "I", "d,s,t", MATCH_PQ_KECCAK_F1600, MASK_PQ_KECCAK_F1600, match_opcode, 0},
{"sha256",             "I", "d,s,t", MATCH_PQ_SHA256, MASK_PQ_SHA256, match_opcode, 0},

{"pq.bs_k2",           "I", "d,s,t", MATCH_PQ_BINOM_SAMPLE_0, MASK_PQ_BINOM_SAMPLE_0, match_opcode, 0},
{"pq.bs_k3",           "I", "d,s,t", MATCH_PQ_BINOM_SAMPLE_1, MASK_PQ_BINOM_SAMPLE_1, match_opcode, 0},
{"pq.bs_k4",           "I", "d,s,t", MATCH_PQ_BINOM_SAMPLE_2, MASK_PQ_BINOM_SAMPLE_2, match_opcode, 0},
{"pq.bs_k5",           "I", "d,s,t", MATCH_PQ_BINOM_SAMPLE_3, MASK_PQ_BINOM_SAMPLE_3, match_opcode, 0},
{"pq.bs_k8",           "I", "d,s,t", MATCH_PQ_BINOM_SAMPLE_4, MASK_PQ_BINOM_SAMPLE_3, match_opcode, 0},

{"pq.mac",             "I", "d,s,t", MATCH_PQ_MAC, MASK_PQ_MAC, match_opcode, 0},

{"multer.write",       "I", "d,s,t", MATCH_PQ_MULTER_WRITE, MASK_PQ_MULTER_WRITE, match_opcode, 0},
{"multer.calc",        "I", "d,s,t", MATCH_PQ_MULTER_CALC, MASK_PQ_MULTER_CALC, match_opcode, 0},
{"multer.read",        "I", "d,s,t", MATCH_PQ_MULTER_READ, MASK_PQ_MULTER_READ, match_opcode, 0},

{"gf.mul",             "I", "d,s,t", MATCH_PQ_GFMUL, MASK_PQ_GFMUL, match_opcode, 0},
{"gf.mulsyn",          "I", "d,s,t", MATCH_PQ_GFSYN, MASK_PQ_GFSYN, match_opcode, 0},
{"gf.mula",            "I", "d,s,t", MATCH_PQ_GFMULA, MASK_PQ_GFMULA, match_opcode, 0},

{"mod.barrett",        "I", "d,s,t", MATCH_PQ_MOD_BARRETT, MASK_PQ_MOD_BARRETT, match_opcode, 0},
